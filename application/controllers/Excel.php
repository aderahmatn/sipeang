...
class Excel extends CI_Controller
{
    ...
    public function export($tahun = null, $id_subkegiatan = null)
    {
        ...
        $sheet->setCellValue('E6', total_per_bulan($tahun . "-01", $id_subkegiatan));
        $sheet->getStyle('E6')->applyFromArray($style_total);
        $sheet->getStyle('E6')->getNumberFormat()->setFormatCode('#,##0');
        $sheet->setCellValue('F6', total_per_bulan($tahun . "-02", $id_subkegiatan));
        $sheet->getStyle('F6')->applyFromArray($style_total);
        $sheet->getStyle('F6')->getNumberFormat()->setFormatCode('#,##0');
        $sheet->setCellValue('G6', total_per_bulan($tahun . "-03", $id_subkegiatan));
        $sheet->getStyle('G6')->applyFromArray($style_total);
        $sheet->getStyle('G6')->getNumberFormat()->setFormatCode('#,##0');
        $sheet->setCellValue('H6', total_per_bulan($tahun . "-04", $id_subkegiatan));
        $sheet->getStyle('H6')->applyFromArray($style_total);
        $sheet->getStyle('H6')->getNumberFormat()->setFormatCode('#,##0');
        $sheet->setCellValue('I6', total_per_bulan($tahun . "-05", $id_subkegiatan));
        $sheet->getStyle('I6')->applyFromArray($style_total);
        $sheet->getStyle('I6')->getNumberFormat()->setFormatCode('#,##0');
        $sheet->setCellValue('J6', total_per_bulan($tahun . "-06", $id_subkegiatan));
        $sheet->getStyle('J6')->applyFromArray($style_total);
        $sheet->getStyle('J6')->getNumberFormat()->setFormatCode('#,##0');
        $sheet->setCellValue('K6', total_per_bulan($tahun . "-07", $id_subkegiatan));
        $sheet->getStyle('K6')->applyFromArray($style_total);
        $sheet->getStyle('K6')->getNumberFormat()->setFormatCode('#,##0');
        $sheet->setCellValue('L6', total_per_bulan($tahun . "-08", $id_subkegiatan));
        $sheet->getStyle('L6')->applyFromArray($style_total);
        $sheet->getStyle('L6')->getNumberFormat()->setFormatCode('#,##0');
        $sheet->setCellValue('M6', total_per_bulan($tahun . "-09", $id_subkegiatan));
        $sheet->getStyle('M6')->applyFromArray($style_total);
        $sheet->getStyle('M6')->getNumberFormat()->setFormatCode('#,##0');
        $sheet->setCellValue('N6', total_per_bulan($tahun . "-10", $id_subkegiatan));
        $sheet->getStyle('N6')->applyFromArray($style_total);
        $sheet->getStyle('N6')->getNumberFormat()->setFormatCode('#,##0');
        $sheet->setCellValue('O6', total_per_bulan($tahun . "-11", $id_subkegiatan));
        $sheet->getStyle('O6')->applyFromArray($style_total);
        $sheet->getStyle('O6')->getNumberFormat()->setFormatCode('#,##0');
        $sheet->setCellValue('P6', total_per_bulan($tahun . "-12", $id_subkegiatan));
        $sheet->getStyle('P6')->applyFromArray($style_total);
        $sheet->getStyle('P6')->getNumberFormat()->setFormatCode('#,##0');
        ...
        $sheet->setCellValue('E7', total_per_bulan($tahun . "-01", $id_subkegiatan));
        $sheet->getStyle('E7')->applyFromArray($style_total);
        $sheet->getStyle('E7')->getNumberFormat()->setFormatCode('#,##0');
        $sheet->setCellValue('F7', total_per_bulan($tahun . "-02", $id_subkegiatan));
        $sheet->getStyle('F7')->applyFromArray($style_total);
        $sheet->getStyle('F7')->getNumberFormat()->setFormatCode('#,##0');
        $sheet->setCellValue('G7', total_per_bulan($tahun . "-03", $id_subkegiatan));
        $sheet->getStyle('G7')->applyFromArray($style_total);
        $sheet->getStyle('G7')->getNumberFormat()->setFormatCode('#,##0');
        $sheet->setCellValue('H7', total_per_bulan($tahun . "-04", $id_subkegiatan));
        $sheet->getStyle('H7')->applyFromArray($style_total);
        $sheet->getStyle('H7')->getNumberFormat()->setFormatCode('#,##0');
        $sheet->setCellValue('I7', total_per_bulan($tahun . "-05", $id_subkegiatan));
        $sheet->getStyle('I7')->applyFromArray($style_total);
        $sheet->getStyle('I7')->getNumberFormat()->setFormatCode('#,##0');
        $sheet->setCellValue('J7', total_per_bulan($tahun . "-06", $id_subkegiatan));
        $sheet->getStyle('J7')->applyFromArray($style_total);
        $sheet->getStyle('J7')->getNumberFormat()->setFormatCode('#,##0');
        $sheet->setCellValue('K7', total_per_bulan($tahun . "-07", $id_subkegiatan));
        $sheet->getStyle('K7')->applyFromArray($style_total);
        $sheet->getStyle('K7')->getNumberFormat()->setFormatCode('#,##0');
        $sheet->setCellValue('L7', total_per_bulan($tahun . "-08", $id_subkegiatan));
        $sheet->getStyle('L7')->applyFromArray($style_total);
        $sheet->getStyle('L7')->getNumberFormat()->setFormatCode('#,##0');
        $sheet->setCellValue('M7', total_per_bulan($tahun . "-09", $id_subkegiatan));
        $sheet->getStyle('M7')->applyFromArray($style_total);
        $sheet->getStyle('M7')->getNumberFormat()->setFormatCode('#,##0');
        $sheet->setCellValue('N7', total_per_bulan($tahun . "-10", $id_subkegiatan));
        $sheet->getStyle('N7')->applyFromArray($style_total);
        $sheet->getStyle('N7')->getNumberFormat()->setFormatCode('#,##0');
        $sheet->setCellValue('O7', total_per_bulan($tahun . "-11", $id_subkegiatan));
        $sheet->getStyle('O7')->applyFromArray($style_total);
        $sheet->getStyle('O7')->getNumberFormat()->setFormatCode('#,##0');
        $sheet->setCellValue('P7', total_per_bulan($tahun . "-12", $id_subkegiatan));
        $sheet->getStyle('P7')->applyFromArray($style_total);
        $sheet->getStyle('P7')->getNumberFormat()->setFormatCode('#,##0');
        ...
        $sheet->setCellValue('E8', total_per_bulan($tahun . "-01", $id_subkegiatan));
        $sheet->getStyle('E8')->applyFromArray($style_total);
        $sheet->getStyle('E8')->getNumberFormat()->setFormatCode('#,##0');
        $sheet->setCellValue('F8', total_per_bulan($tahun . "-02", $id_subkegiatan));
        $sheet->getStyle('F8')->applyFromArray($style_total);
        $sheet->getStyle('F8')->getNumberFormat()->setFormatCode('#,##0');
        $sheet->setCellValue('G8', total_per_bulan($tahun . "-03", $id_subkegiatan));
        $sheet->getStyle('G8')->applyFromArray($style_total);
        $sheet->getStyle('G8')->getNumberFormat()->setFormatCode('#,##0');
        $sheet->setCellValue('H8', total_per_bulan($tahun . "-04", $id_subkegiatan));
        $sheet->getStyle('H8')->applyFromArray($style_total);
        $sheet->getStyle('H8')->getNumberFormat()->setFormatCode('#,##0');
        $sheet->setCellValue('I8', total_per_bulan($tahun . "-05", $id_subkegiatan));
        $sheet->getStyle('I8')->applyFromArray($style_total);
        $sheet->getStyle('I8')->getNumberFormat()->setFormatCode('#,##0');
        $sheet->setCellValue('J8', total_per_bulan($tahun . "-06", $id_subkegiatan));
        $sheet->getStyle('J8')->applyFromArray($style_total);
        $sheet->getStyle('J8')->getNumberFormat()->setFormatCode('#,##0');
        $sheet->setCellValue('K8', total_per_bulan($tahun . "-07", $id_subkegiatan));
        $sheet->getStyle('K8')->applyFromArray($style_total);
        $sheet->getStyle('K8')->getNumberFormat()->setFormatCode('#,##0');
        $sheet->setCellValue('L8', total_per_bulan($tahun . "-08", $id_subkegiatan));
        $sheet->getStyle('L8')->applyFromArray($style_total);
        $sheet->getStyle('L8')->getNumberFormat()->setFormatCode('#,##0');
        $sheet->setCellValue('M8', total_per_bulan($tahun . "-09", $id_subkegiatan));
        $sheet->getStyle('M8')->applyFromArray($style_total);
        $sheet->getStyle('M8')->getNumberFormat()->setFormatCode('#,##0');
        $sheet->setCellValue('N8', total_per_bulan($tahun . "-10", $id_subkegiatan));
        $sheet->getStyle('N8')->applyFromArray($style_total);
        $sheet->getStyle('N8')->getNumberFormat()->setFormatCode('#,##0');
        $sheet->setCellValue('O8', total_per_bulan($tahun . "-11", $id_subkegiatan));
        $sheet->getStyle('O8')->applyFromArray($style_total);
        $sheet->getStyle('O8')->getNumberFormat()->setFormatCode('#,##0');
        $sheet->setCellValue('P8', total_per_bulan($tahun . "-12", $id_subkegiatan));
        $sheet->getStyle('P8')->applyFromArray($style_total);
        $sheet->getStyle('P8')->getNumberFormat()->setFormatCode('#,##0');
